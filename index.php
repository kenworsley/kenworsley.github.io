...
<head>
	...
	<title>kenworsley.github.io</title>
	...
	<div class="slide" id="slide1" data-slide="1" data-stellar-background-ratio="0.2">
		<div class="container clearfix">
			...
			<div id="content" class="grid_12">
				...
				<h2>Let's get started by choosing your type of study:</h2>
                                <ul class="navigation" style="text-align:left;">
                                    <li data-slide="2" style="text-align:left;">Language study</li>
                                </ul>
                                <p><a href="data-slide=3">Undergraduate university</a></p>
                                    <p>Postgraduate university</p>
			</div>
